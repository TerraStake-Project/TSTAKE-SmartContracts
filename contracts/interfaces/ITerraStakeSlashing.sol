...
interface ITerraStakeSlashing {
    ...
    function updateTreasuryManager(address _treasuryManager) external; // Updated function

    function setPaused(bool paused) external; // Updated function

    function recoverERC20(address token, uint256 amount, address recipient) external; // Updated function
    ...
    event TreasuryManagerUpdated(address indexed newManager); // Updated event
